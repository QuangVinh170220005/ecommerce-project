    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-body">
                    <center class="m-t-30"> 
                        <img src="{{asset('admin/assets/images/users/' . $user->avatar)}}" class="rounded-circle" width="150" />
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-body">
					...
					@endif
                    <form class="form-horizontal form-material" method = "post" action="/admin/profile" enctype="multipart/form-data">
                        @csrf
